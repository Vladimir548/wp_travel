                    ...
                    <div <?php if ($slides == 1) {
                      ...
                      <div class="carousel-caption">
                        ...
                        <div class="home-btn my-lg-4 my-md-4 mb-3">
                          <a class="p-lg-3 p-md-2 p-1" href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('soccer_academy_slider_read_more',__('Read More','soccer-academy'))); ?></a>
                        </div>
                      </div>
                    </div>
                    <?php $slides++; endwhile;
