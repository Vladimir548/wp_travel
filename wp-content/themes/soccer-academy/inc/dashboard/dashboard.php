...
function soccer_academy_gettingstarted() {
	add_theme_page( esc_html__('Theme Documentation', 'soccer-academy'), esc_html__('Theme Documentation', 'soccer-academy'), 'edit_theme_options', 'soccer-academy-guide-page', 'soccer_academy_guide');
}
...
define('SOCCER_ACADEMY_LIVE_DEMO',__('https://www.ovationthemes.com/demos/soccer-academy/','soccer-academy'));
}
if ( ! defined( 'SOCCER_ACADEMY_BUY_PRO' ) ) {
define('SOCCER_ACADEMY_BUY_PRO',__('https://www.ovationthemes.com/wordpress/soccer-club-wordpress-theme/','soccer-academy'));
}
if ( ! defined( 'SOCCER_ACADEMY_PRO_DOC' ) ) {
define('SOCCER_ACADEMY_PRO_DOC',__('https://www.ovationthemes.com/docs/ot-soccer-academy-pro-doc/','soccer-academy'));
}
if ( ! defined( 'SOCCER_ACADEMY_FREE_DOC' ) ) {
define('SOCCER_ACADEMY_FREE_DOC',__('https://ovationthemes.com/docs/ot-soccer-academy-free-doc','soccer-academy'));
}
...
function soccer_academy_guide() {
	...
	<div class="getting-started__header">
		...
		<div class="col-md-2">
			<div class="btn_box">
				<a class="button-primary" href="<?php echo esc_url( SOCCER_ACADEMY_FREE_DOC ); ?>" target="_blank"><?php esc_html_e('Instructions', 'soccer-academy'); ?></a>
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<a class="button-primary" href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','soccer-academy'); ?></a>
