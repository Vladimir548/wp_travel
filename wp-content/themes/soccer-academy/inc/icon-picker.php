...
class Soccer_Academy_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'soccer-academy' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $soccer_academy_font_awesome_icon_array = soccer_academy_font_awesome_icon_array();
                    foreach ($soccer_academy_font_awesome_icon_array as $soccer_academy_font_awesome_icon) {
                            $icon_class = $this->value() == $soccer_academy_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($soccer_academy_font_awesome_icon).'"></i>
                            <span class="soccer-academy-social-class">'.esc_attr($soccer_academy_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function soccer_academy_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'soccer-academy-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'soccer_academy_customizer_script' );

if(!function_exists('soccer_academy_font_awesome_icon_array')){
    function soccer_academy_font_awesome_icon_array(){
